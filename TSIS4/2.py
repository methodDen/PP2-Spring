...
import re
# txt = "ДУБЛИКАТ"
# x = re.findall("[А-Я]", txt)
# s = ""
# for ch in x:
# 	s += ch
# print(s)

# txt = "Филиал ТОО EUROPHARMA Астана"
# x = re.findall(r"^Филиал\s[А-Я]{3}\s[A-Z]+\s[А-Я]{1}[а-я]+", txt)

# txt = "БИН 080841000761"
# x = re.findall(r"^БИН\s\d{12}", txt)

# txt = "НДС Серия 58001"
# x = re.findall(r"^НДС\sСерия\s[0-9]{5}$", txt)
